## Confusion matrix to evaluate method performances with resulting scoring indexes ##
...
if __name__ == '__main__':
	...
	with open(IdsPredFile) as filein:
		for id in filein:
			...
			#predicted_SecStr = '/Users/ceciliafoglini/Desktop/Lab2/project/GOR_cv/test4/pred_seq/SS-prediction_'+id+'.dssp' #cv
			with open(observed_SecStr) as observed_SS, open(predicted_SecStr) as predicted_SS:
				for line1, line2 in zip(observed_SS, predicted_SS):
					if len(line1) != len(line2): continue
					if line1[0] == '>': continue
					if line2[0] == '>': continue
					else:
